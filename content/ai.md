...
01
AI 老师，植根二十六年课程
以教过二十七万中国孩子的教材与教法为基底的个人语文伴读人 —— 耐心、随时在场、一对一。
// products · 产品

02
自适应学习路径
阅读、写作与人文课程根据每个孩子的已知、难点与兴趣，实时调整 —— 古典教法为根，现代智能为调。
// curriculum · 课程
...
Personal language and literature companions, trained on the textbooks and pedagogy that have taught 270,000 students in China.
// products

02
Adaptive learning paths, per child
Reading, writing and humanities sequences that adjust in real time — rooted in classical pedagogy, paced by modern intelligence.
// curriculum

03
AI-augmented classrooms
Tools that give teachers more time with students — reading assessment, written-work analysis, lesson-prep companions, live classroom insight.
// classroom
